---
title: "Estadística descriptiva. EDA"
...
![](images/tabla_frecuencias.png){fig-align="center" width="450"}
...
# Gráfico de barras en frecuencia relativa comparando ambas muestras
...
# Cargar el conjunto de datos de los pingüinos
datos <- na.omit(penguins[, c("species", "sex")])  # Eliminar filas con datos faltantes en species o sex

# Crear el gráfico de barras agrupado
grafico_sexo_especie <- ggplot(datos, aes(x = species, fill = sex)) +
  geom_bar(position = "dodge", color = "black") +
  labs(title = "Distribución del Sexo de los Pingüinos por Especie",
       x = "Especie", y = "Frecuencia",
       fill = "Sexo") +
  theme_minimal()

# Mostrar el gráfico
print(grafico_sexo_especie)
...
# Cargar el conjunto de datos de los pingüinos
datos <- na.omit(penguins$species)  # Eliminar valores faltantes en species
...
![](images/dispersion.png){fig-align="center" width="270"}
